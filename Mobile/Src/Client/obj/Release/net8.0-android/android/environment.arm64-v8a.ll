...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670992, ; uint32_t jnienv_initialize_method_token (0x6001e10)
	i32 100670991, ; uint32_t jnienv_registerjninatives_method_token (0x6001e0f)
...
@dso_cache = dso_local local_unnamed_addr global [642 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-System.IdentityModel.Tokens.Jwt.dll.so
		ptr null; void* handle (0x0)
	}, ; 74
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4543304196897406076, ; hash 0x3f0d0f187a9c7c7c, from name: libaot-Client.Infrastructure
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6973975455318525775, ; hash 0x60c889ba168dc74f, from name: aot-Client.Infrastructure
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 210
	...
	%struct.DSOCacheEntry {
		i64 7624434774981476227, ; hash 0x69cf6f0827e7ff83, from name: Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 238
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8381604729589167482, ; hash 0x745171180ae5757a, from name: Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 270
	...
	%struct.DSOCacheEntry {
		i64 8811466767477159999, ; hash 0x7a489e5701a2b83f, from name: aot-Client.Infrastructure.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 298
	...
	%struct.DSOCacheEntry {
		i64 10153485009370397595, ; hash 0x8ce86cd20fc6bb9b, from name: libaot-Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 344
	...
	%struct.DSOCacheEntry {
		i64 11723494942932390334, ; hash 0xa2b238896f92d1be, from name: libaot-Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 402
	...
	%struct.DSOCacheEntry {
		i64 13195348459533232824, ; hash 0xb71f4b8311f9eab8, from name: Client.Infrastructure.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
	...
	%struct.DSOCacheEntry {
		i64 15549354291606136497, ; hash 0xd7ca67581de126b1, from name: aot-Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 541
	...
	%struct.DSOCacheEntry {
		i64 15635367805608354214, ; hash 0xd8fbfc2df1dd61a6, from name: libaot-Client.Infrastructure.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 547
	...
	%struct.DSOCacheEntry {
		i64 16488464532950089626, ; hash 0xe4d2cb22121dff9a, from name: aot-Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 574
	...
	%struct.DSOCacheEntry {
		i64 17317683239488641116, ; hash 0xf054c5273e74d85c, from name: Client.Infrastructure
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 600
...
@.env.3 = private unnamed_addr constant [37 x i8] c"e577852f-c76d-48cf-8b1c-a330073df3fa\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [36 x i8] c"libaot-Client.Infrastructure.dll.so\00", align 1
@.DSOCacheEntry.8_name = private unnamed_addr constant [21 x i8] c"libaot-Shared.dll.so\00", align 1
@.DSOCacheEntry.9_name = private unnamed_addr constant [21 x i8] c"libaot-Client.dll.so\00", align 1
...
@.DSOCacheEntry.28_name = private unnamed_addr constant [52 x i8] c"libaot-Microsoft.Maui.Controls.Compatibility.dll.so\00", align 1
...
@.DSOCacheEntry.34_name = private unnamed_addr constant [46 x i8] c"libaot-System.IdentityModel.Tokens.Jwt.dll.so\00", align 1
