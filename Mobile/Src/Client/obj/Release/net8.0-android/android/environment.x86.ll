...
@dso_cache = dso_local local_unnamed_addr global [642 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 143494631, ; hash 0x88d8de7, from name: aot-Shared
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 170695943, ; hash 0xa2c9d07, from name: aot-Client.Infrastructure
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 645360334, ; hash 0x26776ace, from name: Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	...
	%struct.DSOCacheEntry {
		i64 1063458855, ; hash 0x3f631827, from name: libaot-Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 146
	...
	%struct.DSOCacheEntry {
		i64 1315878943, ; hash 0x4e6eb81f, from name: Client.Infrastructure.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	...
	%struct.DSOCacheEntry {
		i64 1533565649, ; hash 0x5b685ad1, from name: libaot-Client.Infrastructure.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 222
	...
	%struct.DSOCacheEntry {
		i64 2088561200, ; hash 0x7c7cea30, from name: Client.Infrastructure
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 2282532511, ; hash 0x880cae9f, from name: aot-Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 328
	...
	%struct.DSOCacheEntry {
		i64 2508592708, ; hash 0x95861644, from name: aot-Client.Infrastructure.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 368
	...
	%struct.DSOCacheEntry {
		i64 2625611736, ; hash 0x9c7fa7d8, from name: Shared.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 387
	...
	%struct.DSOCacheEntry {
		i64 4217294669, ; hash 0xfb5ecf4d, from name: libaot-Client.Infrastructure
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Client.Infrastructure.dll.so
		ptr null; void* handle (0x0)
	}, ; 630
	...
	%struct.DSOCacheEntry {
		i64 4240301006, ; hash 0xfcbddbce, from name: libaot-Shared
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Shared.dll.so
		ptr null; void* handle (0x0)
	}, ; 633
